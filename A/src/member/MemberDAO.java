...
public class MemberDAO {
	public String getGrade(String id) {
		...
		sql.append(" select grade from Amember ");
		sql.append(" where id = ? ");
	...
	public boolean loginCheck(String id, String passwd) {
		...
		sql.append(" select count(*) from Amember ");
		sql.append(" where id = ? ");
	...
	public boolean delete(String id) {
		...
		sql.append(" delete from Amember ");
		sql.append(" where id = ? ");
	...
	public String getFname(String id) {
		...
		ResultSet rs = null;
		StringBuffer sql = new StringBuffer();
		sql.append(" select fname from Amember ");
		sql.append(" where id = ? ");
	...
	public boolean create(MemberDTO dto) {
		...
		sql.append(" INSERT INTO Amember(id, passwd, mname, tel, email, zipcode,   ");
